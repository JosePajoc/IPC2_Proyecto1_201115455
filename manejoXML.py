...
class archivoXML():                                                 #Creando clase para el archivo XML
    ...
    def ProcesarArchivo(self):                                      #Obtener atributos de cada matriz
        ...
        for matriz in matricesRaiz:                                 #Recorriendo etiqueta "matriz"
            ...
            print(matrizEntrada)
            time.sleep(2)
            print('\nCalculando matriz de frecuencia...')
            time.sleep(3)
            ...
            print('\nRealizando la suma de las filas que poseen la misma frecuencia...')
            time.sleep(3)
    ...
    def generarGrafica(self):
        print('El gráfico y el archivo DOT se creará en la carpeta raíz del proyecto')
        time.sleep(4)
